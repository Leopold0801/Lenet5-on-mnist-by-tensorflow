...
def train(mnist):
    ...
    regularizer = tf.contrib.layers.l2_regularizer(REGULARAZTION_RATE) #加入l2正则化防止过拟合
    ...
    cross_entropy = tf.nn.sparse_softmax_cross_entropy_with_logits(logits=y, labels=tf.argmax(y_, 1)) #������֤������
